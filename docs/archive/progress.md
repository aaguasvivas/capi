...
> Historical: the milestone log of the web-only MVP. Later milestones (mobile, store readiness, iMessage, ads and IAP) are tracked in docs/superpowers/plans/. Kept for context, not maintained.
